...
import { PaymentConfirmationModal, type PaymentConfirmation } from '@/components/PaymentConfirmationModal';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 py-4">
      ...
      <PaymentConfirmationModal
        confirmation={confirmPayment ? {
          title: confirmPayment.episode.title,
          amount: confirmPayment.amount,
          recipients: confirmPayment.recipients,
          processing: confirmPayment.processing,
          recipientStatus: confirmPayment.recipientStatus
        } : null}
